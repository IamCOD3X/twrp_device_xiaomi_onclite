...
BOARD_SUPER_PARTITION_GROUPS := onc_dynamic_partition
BOARD_ONC_DYNAMIC_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_ONC_DYNAMIC_PARTITION_LIST := odm product system system_ext vendor
